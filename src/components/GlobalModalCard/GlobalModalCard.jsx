      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mx-auto">
        <div className="flex flex-wrap gap-4 justify-center items-center">
          ...
          <Image
            ...
            width={300}
            height={300}
            alt={`Modal Image ${selectImage}`}
          />
        </div>
        <div>
          <h2 className="text-2xl sm:text-4xl text-[#663130] font-bold">
            {title}
          </h2>
          ...
          <p className="text-gray-400">
            {singleProductData?.desc?.slice(0, 450)}
          </p>
          <div className="flex gap-4 my-4 items-center">
            ...
            <InputNumber
              ...
              value={
                currentCart?.find(
                  (checkProduct) => checkProduct?._id === singleProductData?._id
                )?.quantity || 0
              }
            />
            <Button
          ...
          <div className="flex gap-5 mt-5">
            ...
            >
              Add To Cart{" "}
              <i className="mt-1 hover:text-[#381B1A] fa-solid fa-cart-shopping"></i>
            </button>
            <button
            ...
            >
              Add To Wishlist{" "}
              <i className="mt-1 hover:text-[#381B1A] fa-solid fa-heart"></i>
            </button>
          </div>
        </div>
      </div>
