...
export default function SingleProductCart({ data }) {
  ...
  if (!productLoading && !productError && allProductData.data.length > 0) {
    const categoryWiseData = allProductData.data.filter(
      (item) => item?.category._id === data?.category._id
    );
  ...
  return (
    <div className="w-full">
        ...
        <div className="grid grid-cols-12 ">
          ...
          <div className="mx-3 sm:mx-4 md:mx-5 col-span-12 md:col-span-6 lg:col-span-5 justify-between items-center">
            ...
            <div className="flex gap-4 my-4 items-center">
              <Button
                className="font-bold border-[#663130]"
              ...
              <InputNumber
                ...
                value={
                  currentCart?.find(
                    (checkProduct) =>
                      checkProduct?._id === singleProductData?._id
                  )?.quantity || 0
                }
              ></InputNumber>
              <Button
            ...
            <Button
              onClick={() => handelAddToCart(singleProductData)}
              className="font-bold mr-3 border-[#663130]"
            >
              Add To Cart
            </Button>

            <Button
              onClick={() => wishlistHandeler(singleProductData)}
              className="font-bold mr-3 border-[#663130]"
            >
              Add To Wishlist
            </Button>
      ...
      <div className="container mx-auto my-10">
        <h2 className="text-2xl font-bold py-5 px-10 bg-slate-100">
          Relative products
        </h2>
